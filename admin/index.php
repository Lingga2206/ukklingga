            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="alert alert-info">
                        <h6>Selamat Datang <b><?php echo $_SESSION['role'], ' - ',  $_SESSION['NamaLengkap'] ?></b> Di Halaman Admin<b> Perpus Digital SMK Ma'arif Walisongo Kajoran </b>!</h6>
                    </div>
                </div>
                <!-- /.col-md-6 -->
            </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="petugas/petugas.php">
                                <img src="../assets/dashboardCardMember/petugas1.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="buku/daftarBuku.php">
                                <img src="../assets/dashboardCardMember/buku1.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="kategori/kategori.php">
                                <img src="../assets/dashboardCardMember/kategori1.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="pengembalian/pengembalian.php">
                                <img src="../assets/dashboardCardMember/pengembalian1.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="denda/daftarDenda.php">
                                <img src="../assets/dashboardCardMember/daftardenda.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="cardImg">
                            <a href="denda/pengelolaanDenda.php">
                                <img src="../assets/dashboardCardMember/keloladenda.png" alt="daftar buku" style="max-width: 100%;" width="600px">
                            </a>
                        </div>
                    </div>
                </div>
